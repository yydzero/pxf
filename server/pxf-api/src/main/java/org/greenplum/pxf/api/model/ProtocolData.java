...
//            setProfilePlugins();
//        }
//        accessor = getOption("ACCESSOR");
//        if(accessor == null) {
//            protocolViolation("ACCESSOR");
//        }
//        resolver = getOption("RESOLVER");
//        if(resolver == null) {
//            protocolViolation("RESOLVER");
//        }
//
//        fragmenter = getOption("FRAGMENTER");
...
//
//        setServerName(getOption("SERVER"));
//
...
//
//        threadSafe = true;
//        String threadSafeStr = getOption("THREAD-SAFE");
...
//
//        String maxFrags = getOption("STATS-MAX-FRAGMENTS");
...
//        }
//
//        String sampleRatioStr = getOption("STATS-SAMPLE-RATIO");
